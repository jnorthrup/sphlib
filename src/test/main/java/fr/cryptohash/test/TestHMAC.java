 package fr.cryptohash.test; import fr.cryptohash.*; import junit.framework.TestCase; import static  fr.cryptohash.TestDigest.*; public class TestHMAC extends TestCase{     void testHMAC() {
        Digest hmac;
        ...
        testKat(hmac, "The successful verification of a MAC does not completely guarantee that the accompanying message is authentic.", "D1674B83B37830E6AF7DBCC6260E3DECB8BB23F56DDA2CA828C60B87");
        hmac = new HMAC(new BMW224(),
                strtobin("505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F707172737475767778797A7B7C7D7E7F808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9FA0A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3"));
        testKat(hmac, "The successful verification of a MAC does not completely guarantee that the accompanying message is authentic: there is a chance that a source with no knowledge of the key can present a purported MAC.", "16F9D79EF410A118DDD398396A6A3FD0AC9816ED7110ECA90A05430A");
        ...
        hmac = new HMAC(new BMW256(),
                strtobin("505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F707172737475767778797A7B7C7D7E7F808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9FA0A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3"));
        testKat(hmac, "The successful verification of a MAC does not completely guarantee that the accompanying message is authentic: there is a chance that a source with no knowledge of the key can present a purported MAC.", "F5C8A1F531FD09D1F33845E705075A8CE5EEB29B33EFF70BAE97B750E3231383");
        ...
        hmac = new HMAC(new BMW384(),
                strtobin("303132333435363738393A3B3C3D3E3F40414243"));
        testKat(hmac, "Sample #2", "9E7DAF3407CB1BC0CA3101F93A3D857B44815D0C7203BC66DE907C6C3DE7E322E78A9072B285C97BEED23A85521F5EE7");
        hmac = new HMAC(new BMW384(),
        ...
        testKat(hmac, "The successful verification of a MAC does not completely guarantee that the accompanying message is authentic.", "515079D15A09C721C63F3E1011DC78837D1362753377F861FF34F9E884B84EA0A60ADA03AF5FC724870CCA900EC8E3B5");
        hmac = new HMAC(new BMW384(),
                strtobin("505152535455565758595A5B5C5D5E5F606162636465666768696A6B6C6D6E6F707172737475767778797A7B7C7D7E7F808182838485868788898A8B8C8D8E8F909192939495969798999A9B9C9D9E9FA0A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3"));
        ...
        hmac = new HMAC(new BMW512(),
                strtobin("303132333435363738393A3B3C3D3E3F40414243"));
        testKat(hmac, "Sample #2", "CEF9110B1F90A24080C8CE794FD922F8669A1A0A74299DB9789D9BD9CCC8BA7E9438BD2383F14D3C9278FDB65C0A3FCFCBF2EB570C08588488F5F9AF428D8F67");
        hmac = new HMAC(new BMW512(),
                strtobin(""));
